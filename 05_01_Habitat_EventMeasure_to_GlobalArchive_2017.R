...
# Set directories----
rm(list=ls())
study<-"PointAddis2017"

data.dir=("/Users/samwines/Desktop/Uni-Honours/02_Data/07_HabitatData/Langlois_Format/2017")
...
setwd(habitat.data)
dir()
hab<-read.delim('AD_2017_Dot Point Measurements.txt',header=T,skip=4,stringsAsFactors=FALSE)%>%
