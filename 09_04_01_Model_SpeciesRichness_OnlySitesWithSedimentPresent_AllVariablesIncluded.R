...
# This script is for modelling species richness of sites on sediment
...
write.table(BestModelSelection, file = "01_BestModelSelection_SpeciesRichness.SEDIMENT.txt" , sep = "\t", row.names = FALSE)
...
output.VI$Subset <- "SEDIMENT"

VariableImportance <- output.VI %>%
  dplyr::select("BestModel.Variables", "Subset", "VariableImportance")

write.table(VariableImportance, file = "01_VariableImportance_SEDIMENT.txt" , sep = "\t", row.names = FALSE)
...
# Make GAM Plots
pdf(file = "SEDIMENT_Best_Plots.pdf")
plot.gam(BestModel)
dev.off()
...
SpeciesRichness.SEDIMENT_AICc_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AICc, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.SEDIMENT_AICc_01
ggsave("AICc_SpeciesRichness.SEDIMENT_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.SEDIMENT_Weight_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$weight, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.SEDIMENT_Weight_01
ggsave("Weight_SpeciesRichness.SEDIMENT_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.SEDIMENT_Pred.Obs.Correlation_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Pred.Obs.Correlation, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.SEDIMENT_Pred.Obs.Correlation_01
ggsave("Pred.Obs.Correlation_SpeciesRichness.SEDIMENT_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.SEDIMENT_logLik_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$logLik, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.SEDIMENT_logLik_01
ggsave("logLik_SpeciesRichness.SEDIMENT_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.SEDIMENT_AIC.mgcv_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AIC.mgcv, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.SEDIMENT_AIC.mgcv_01
ggsave("AICmgcv_SpeciesRichness.SEDIMENT_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.SEDIMENT_DevExplained_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Deviance.Explained, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.SEDIMENT_DevExplained_01
ggsave("DevExplained_SpeciesRichness.SEDIMENT_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)
