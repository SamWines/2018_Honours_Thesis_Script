...
# This script is for modelling species richness of sites with macroalgae present
...
write.table(BestModelSelection, file = "01_BestModelSelection_SpeciesRichness.MACROALGAE.txt" , sep = "\t", row.names = FALSE)
...
output.VI$Subset <- "MACROALGAE"

VariableImportance <- output.VI %>%
  dplyr::select("BestModel.Variables", "Subset", "VariableImportance")

write.table(VariableImportance, file = "01_VariableImportance_MACROALGAE.txt" , sep = "\t", row.names = FALSE)
...
# Make GAM Plots
pdf(file = "MACROALGAE_Best_Plots.pdf")
plot.gam(BestModel)
dev.off()
...
SpeciesRichness.MACROALGAE_AICc_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AICc, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.MACROALGAE_AICc_01
ggsave("AICc_SpeciesRichness.MACROALGAE_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.MACROALGAE_Weight_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$weight, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.MACROALGAE_Weight_01
ggsave("Weight_SpeciesRichness.MACROALGAE_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.MACROALGAE_Pred.Obs.Correlation_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Pred.Obs.Correlation, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.MACROALGAE_Pred.Obs.Correlation_01
ggsave("Pred.Obs.Correlation_SpeciesRichness.MACROALGAE_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.MACROALGAE_logLik_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$logLik, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.MACROALGAE_logLik_01
ggsave("logLik_SpeciesRichness.MACROALGAE_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.MACROALGAE_AIC.mgcv_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AIC.mgcv, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.MACROALGAE_AIC.mgcv_01
ggsave("AICmgcv_SpeciesRichness.MACROALGAE_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.MACROALGAE_DevExplained_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Deviance.Explained, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.MACROALGAE_DevExplained_01
ggsave("DevExplained_SpeciesRichness.MACROALGAE_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)
