...
TestData.5m.SpeciesRichness$Predicted.Species.Richness.5m <- as.numeric(predict.gam(ModelsResults.5m[[best.model.5m]], TestData.5m.SpeciesRichness))
...
best.model.5m.residuals <- residuals(ModelsResults.5m[[best.model.5m]])
best.model.10m.residuals <- residuals(ModelsResults.10m[[best.model.10m]])
best.model.25m.residuals <- residuals(ModelsResults.25m[[best.model.25m]])
best.model.50m.residuals <- residuals(ModelsResults.50m[[best.model.50m]])
best.model.75m.residuals <- residuals(ModelsResults.75m[[best.model.75m]])
best.model.100m.residuals <- residuals(ModelsResults.100m[[best.model.100m]])
best.model.150m.residuals <- residuals(ModelsResults.150m[[best.model.150m]])
best.model.200m.residuals <- residuals(ModelsResults.200m[[best.model.200m]])
best.model.250m.residuals <- residuals(ModelsResults.250m[[best.model.250m]])
best.model.300m.residuals <- residuals(ModelsResults.300m[[best.model.300m]])
best.model.400m.residuals <- residuals(ModelsResults.400m[[best.model.400m]])
best.model.500m.residuals <- residuals(ModelsResults.500m[[best.model.500m]])
...
SpeciesRichness_AICc_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AICc, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness_AICc_01
ggsave("AICc_SpeciesRichness_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness_Weight_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$weight, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness_Weight_01
ggsave("Weight_SpeciesRichness_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness_Pred.Obs.Correlation_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Pred.Obs.Correlation, group=1)) +
  geom_line()+
  geom_point()+
  xlab("Scale(m)") + ylab("Species Richness Predictive Correlation") +
  theme_classic() +
  theme(  legend.background = element_rect(fill = "transparent"), # get rid of legend bg
          legend.box.background = element_rect(fill = "transparent"),
          legend.position="none",
...
SpeciesRichness_Pred.Obs.Correlation_01
ggsave("Pred.Obs.Correlation_SpeciesRichness_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness_logLik_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$logLik, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness_logLik_01
ggsave("logLik_SpeciesRichness_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)
