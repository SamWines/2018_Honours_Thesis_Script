...
TestData.5m.C.auratus.Abundance$Predicted.Species.Richness.5m <- as.numeric(predict.gam(Cons_5m_SpRichness_ENTIRE, TestData.5m.C.auratus.Abundance))
...
TrainingData.10m.C.auratus.Abundance$Year <- factor(TrainingData.10m.C.auratus.Abundance$Year)
TrainingData.10m.C.auratus.Abundance$Status <- factor(TrainingData.10m.C.auratus.Abundance$Status)
TestData.10m.C.auratus.Abundance$Year <- factor(TestData.10m.C.auratus.Abundance$Year)
TestData.10m.C.auratus.Abundance$Status <- factor(TestData.10m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.10m.C.auratus.Abundance$Predicted.Species.Richness.10m <- as.numeric(predict.gam(Cons_10m_SpRichness_ENTIRE, TestData.10m.C.auratus.Abundance))
...
TrainingData.25m.C.auratus.Abundance$Year <- factor(TrainingData.25m.C.auratus.Abundance$Year)
TrainingData.25m.C.auratus.Abundance$Status <- factor(TrainingData.25m.C.auratus.Abundance$Status)
TestData.25m.C.auratus.Abundance$Year <- factor(TestData.25m.C.auratus.Abundance$Year)
TestData.25m.C.auratus.Abundance$Status <- factor(TestData.25m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.25m.C.auratus.Abundance$Predicted.Species.Richness.25m <- as.numeric(predict.gam(Cons_25m_SpRichness_ENTIRE, TestData.25m.C.auratus.Abundance))
...
TrainingData.50m.C.auratus.Abundance$Year <- factor(TrainingData.50m.C.auratus.Abundance$Year)
TrainingData.50m.C.auratus.Abundance$Status <- factor(TrainingData.50m.C.auratus.Abundance$Status)
TestData.50m.C.auratus.Abundance$Year <- factor(TestData.50m.C.auratus.Abundance$Year)
TestData.50m.C.auratus.Abundance$Status <- factor(TestData.50m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.50m.C.auratus.Abundance$Predicted.Species.Richness.50m <- as.numeric(predict.gam(Cons_50m_SpRichness_ENTIRE, TestData.50m.C.auratus.Abundance))
...
TrainingData.75m.C.auratus.Abundance$Year <- factor(TrainingData.75m.C.auratus.Abundance$Year)
TrainingData.75m.C.auratus.Abundance$Status <- factor(TrainingData.75m.C.auratus.Abundance$Status)
TestData.75m.C.auratus.Abundance$Year <- factor(TestData.75m.C.auratus.Abundance$Year)
TestData.75m.C.auratus.Abundance$Status <- factor(TestData.75m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.75m.C.auratus.Abundance$Predicted.Species.Richness.75m <- as.numeric(predict.gam(Cons_75m_SpRichness_ENTIRE, TestData.75m.C.auratus.Abundance))
...
TrainingData.100m.C.auratus.Abundance$Year <- factor(TrainingData.100m.C.auratus.Abundance$Year)
TrainingData.100m.C.auratus.Abundance$Status <- factor(TrainingData.100m.C.auratus.Abundance$Status)
TestData.100m.C.auratus.Abundance$Year <- factor(TestData.100m.C.auratus.Abundance$Year)
TestData.100m.C.auratus.Abundance$Status <- factor(TestData.100m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.100m.C.auratus.Abundance$Predicted.Species.Richness.100m <- as.numeric(predict.gam(Cons_100m_SpRichness_ENTIRE, TestData.100m.C.auratus.Abundance))
...
TrainingData.150m.C.auratus.Abundance$Year <- factor(TrainingData.150m.C.auratus.Abundance$Year)
TrainingData.150m.C.auratus.Abundance$Status <- factor(TrainingData.150m.C.auratus.Abundance$Status)
TestData.150m.C.auratus.Abundance$Year <- factor(TestData.150m.C.auratus.Abundance$Year)
TestData.150m.C.auratus.Abundance$Status <- factor(TestData.150m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.150m.C.auratus.Abundance$Predicted.Species.Richness.150m <- as.numeric(predict.gam(Cons_150m_SpRichness_ENTIRE, TestData.150m.C.auratus.Abundance))
...
TrainingData.200m.C.auratus.Abundance$Year <- factor(TrainingData.200m.C.auratus.Abundance$Year)
TrainingData.200m.C.auratus.Abundance$Status <- factor(TrainingData.200m.C.auratus.Abundance$Status)
TestData.200m.C.auratus.Abundance$Year <- factor(TestData.200m.C.auratus.Abundance$Year)
TestData.200m.C.auratus.Abundance$Status <- factor(TestData.200m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.200m.C.auratus.Abundance$Predicted.Species.Richness.200m <- as.numeric(predict.gam(Cons_200m_SpRichness_ENTIRE, TestData.200m.C.auratus.Abundance))
...
TrainingData.250m.C.auratus.Abundance$Year <- factor(TrainingData.250m.C.auratus.Abundance$Year)
TrainingData.250m.C.auratus.Abundance$Status <- factor(TrainingData.250m.C.auratus.Abundance$Status)
TestData.250m.C.auratus.Abundance$Year <- factor(TestData.250m.C.auratus.Abundance$Year)
TestData.250m.C.auratus.Abundance$Status <- factor(TestData.250m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.250m.C.auratus.Abundance$Predicted.Species.Richness.250m <- as.numeric(predict.gam(Cons_250m_SpRichness_ENTIRE, TestData.250m.C.auratus.Abundance))
...
TrainingData.300m.C.auratus.Abundance$Year <- factor(TrainingData.300m.C.auratus.Abundance$Year)
TrainingData.300m.C.auratus.Abundance$Status <- factor(TrainingData.300m.C.auratus.Abundance$Status)
TestData.300m.C.auratus.Abundance$Year <- factor(TestData.300m.C.auratus.Abundance$Year)
TestData.300m.C.auratus.Abundance$Status <- factor(TestData.300m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.300m.C.auratus.Abundance$Predicted.Species.Richness.300m <- as.numeric(predict.gam(Cons_300m_SpRichness_ENTIRE, TestData.300m.C.auratus.Abundance))
...
TrainingData.400m.C.auratus.Abundance$Year <- factor(TrainingData.400m.C.auratus.Abundance$Year)
TrainingData.400m.C.auratus.Abundance$Status <- factor(TrainingData.400m.C.auratus.Abundance$Status)
TestData.400m.C.auratus.Abundance$Year <- factor(TestData.400m.C.auratus.Abundance$Year)
TestData.400m.C.auratus.Abundance$Status <- factor(TestData.400m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.400m.C.auratus.Abundance$Predicted.Species.Richness.400m <- as.numeric(predict.gam(Cons_400m_SpRichness_ENTIRE, TestData.400m.C.auratus.Abundance))
...
TrainingData.500m.C.auratus.Abundance$Year <- factor(TrainingData.500m.C.auratus.Abundance$Year)
TrainingData.500m.C.auratus.Abundance$Status <- factor(TrainingData.500m.C.auratus.Abundance$Status)
TestData.500m.C.auratus.Abundance$Year <- factor(TestData.500m.C.auratus.Abundance$Year)
TestData.500m.C.auratus.Abundance$Status <- factor(TestData.500m.C.auratus.Abundance$Status)
...
# Predict for test data
TestData.500m.C.auratus.Abundance$Predicted.Species.Richness.500m <- as.numeric(predict.gam(Cons_500m_SpRichness_ENTIRE, TestData.500m.C.auratus.Abundance))
