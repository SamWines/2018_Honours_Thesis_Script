...
# This script is for modelling species richness of sites on reef
...
write.table(BestModelSelection, file = "01_BestModelSelection_SpeciesRichness.REEF.txt" , sep = "\t", row.names = FALSE)
...
output.VI$Subset <- "ENTIRE"

VariableImportance <- output.VI %>%
  dplyr::select("BestModel.Variables", "Subset", "VariableImportance")

write.table(VariableImportance, file = "01_VariableImportance_ENTIRE.txt" , sep = "\t", row.names = FALSE)
...
# Make GAM Plots
pdf(file = "ENTIRE_Best_Plots.pdf")
plot.gam(BestModel)
dev.off()
...
SpeciesRichness.REEF_AICc_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AICc, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.REEF_AICc_01
ggsave("AICc_SpeciesRichness.REEF_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.REEF_Weight_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$weight, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.REEF_Weight_01
ggsave("Weight_SpeciesRichness.REEF_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.REEF_Pred.Obs.Correlation_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Pred.Obs.Correlation, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.REEF_Pred.Obs.Correlation_01
ggsave("Pred.Obs.Correlation_SpeciesRichness.REEF_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.REEF_logLik_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$logLik, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.REEF_logLik_01
ggsave("logLik_SpeciesRichness.REEF_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.REEF_AIC.mgcv_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AIC.mgcv, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.REEF_AIC.mgcv_01
ggsave("AICmgcv_SpeciesRichness.REEF_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness.REEF_DevExplained_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Deviance.Explained, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness.REEF_DevExplained_01
ggsave("DevExplained_SpeciesRichness.REEF_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)
