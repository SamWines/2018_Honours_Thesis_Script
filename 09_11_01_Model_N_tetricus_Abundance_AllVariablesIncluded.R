...
ggcorr(TrainingData.5m.N.tetricus.Abundance[, 2:length(TrainingData.5m.N.tetricus.Abundance)], method = c("pairwise", "spearman"), geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
...
### Transformations
# Example: TrainingData.5m.N.tetricus.Abundance$sqrt.rugosity_mean_5_clip_01=sqrt(TrainingData.5m.N.tetricus.Abundance$rugosity_mean_5_clip_01)
...
for(i in seq(COMB.5m)){
  ...
  for(j in seq(ncol(tmp.5m))){
    k.5m <- k.5m + 1
    COMB2.5m[[k.5m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.5m[,j], collapse=" + ")))
  }
}
...
TestData.5m.N.tetricus.Abundance$Predicted.Species.Richness.5m <- predict.gam(ModelsResults.5m[[best.model.5m]], TestData.5m.N.tetricus.Abundance)
...
ggcorr(TrainingData.10m.N.tetricus.Abundance[, 2:length(TrainingData.10m.N.tetricus.Abundance)], method = c("pairwise", "spearman"), geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.10m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.10m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.10m.N.tetricus.Abundance$sqrt.rugosity_mean_10_clip_01=sqrt(TrainingData.10m.N.tetricus.Abundance$rugosity_mean_10_clip_01)
...
for(i in seq(COMB.10m)){
  ...
  for(j in seq(ncol(tmp.10m))){
    k.10m <- k.10m + 1
    COMB2.10m[[k.10m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.10m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.10m.N.tetricus.Abundance$Predicted.Species.Richness.10m <- predict.gam(ModelsResults.10m[[best.model.10m]], TestData.10m.N.tetricus.Abundance)
...
ggcorr(TrainingData.25m.N.tetricus.Abundance[, 2:length(TrainingData.25m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.25m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.25m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.25m.N.tetricus.Abundance$sqrt.rugosity_mean_25_clip_01=sqrt(TrainingData.25m.N.tetricus.Abundance$rugosity_mean_25_clip_01)
...
for(i in seq(COMB.25m)){
  ...
  for(j in seq(ncol(tmp.25m))){
    k.25m <- k.25m + 1
    COMB2.25m[[k.25m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.25m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.25m.N.tetricus.Abundance$Predicted.Species.Richness.25m <- predict.gam(ModelsResults.25m[[best.model.25m]], TestData.25m.N.tetricus.Abundance)
...
ggcorr(TrainingData.50m.N.tetricus.Abundance[, 2:length(TrainingData.50m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.50m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.50m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.50m.N.tetricus.Abundance$sqrt.rugosity_mean_50_clip_01=sqrt(TrainingData.50m.N.tetricus.Abundance$rugosity_mean_50_clip_01)
...
for(i in seq(COMB.50m)){
  ...
  for(j in seq(ncol(tmp.50m))){
    k.50m <- k.50m + 1
    COMB2.50m[[k.50m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.50m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.50m.N.tetricus.Abundance$Predicted.Species.Richness.50m <- predict.gam(ModelsResults.50m[[best.model.50m]], TestData.50m.N.tetricus.Abundance)
...
ggcorr(TrainingData.75m.N.tetricus.Abundance[, 2:length(TrainingData.75m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.75m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.75m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.75m.N.tetricus.Abundance$sqrt.rugosity_mean_75_clip_01=sqrt(TrainingData.75m.N.tetricus.Abundance$rugosity_mean_75_clip_01)
...
for(i in seq(COMB.75m)){
  ...
  for(j in seq(ncol(tmp.75m))){
    k.75m <- k.75m + 1
    COMB2.75m[[k.75m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.75m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.75m.N.tetricus.Abundance$Predicted.Species.Richness.75m <- predict.gam(ModelsResults.75m[[best.model.75m]], TestData.75m.N.tetricus.Abundance)
...
ggcorr(TrainingData.100m.N.tetricus.Abundance[, 2:length(TrainingData.100m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.100m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.100m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.100m.N.tetricus.Abundance$sqrt.rugosity_mean_100_clip_01=sqrt(TrainingData.100m.N.tetricus.Abundance$rugosity_mean_100_clip_01)
...
for(i in seq(COMB.100m)){
  ...
  for(j in seq(ncol(tmp.100m))){
    k.100m <- k.100m + 1
    COMB2.100m[[k.100m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.100m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.100m.N.tetricus.Abundance$Predicted.Species.Richness.100m <- predict.gam(ModelsResults.100m[[best.model.100m]], TestData.100m.N.tetricus.Abundance)
...
ggcorr(TrainingData.150m.N.tetricus.Abundance[, 2:length(TrainingData.150m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.150m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.150m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.150m.N.tetricus.Abundance$sqrt.rugosity_mean_150_clip_01=sqrt(TrainingData.150m.N.tetricus.Abundance$rugosity_mean_150_clip_01)
...
for(i in seq(COMB.150m)){
  ...
  for(j in seq(ncol(tmp.150m))){
    k.150m <- k.150m + 1
    COMB2.150m[[k.150m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.150m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.150m.N.tetricus.Abundance$Predicted.Species.Richness.150m <- predict.gam(ModelsResults.150m[[best.model.150m]], TestData.150m.N.tetricus.Abundance)
...
ggcorr(TrainingData.200m.N.tetricus.Abundance[, 2:length(TrainingData.200m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.200m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.200m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.200m.N.tetricus.Abundance$sqrt.rugosity_mean_200_clip_01=sqrt(TrainingData.200m.N.tetricus.Abundance$rugosity_mean_200_clip_01)
...
for(i in seq(COMB.200m)){
  ...
  for(j in seq(ncol(tmp.200m))){
    k.200m <- k.200m + 1
    COMB2.200m[[k.200m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.200m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.200m.N.tetricus.Abundance$Predicted.Species.Richness.200m <- predict.gam(ModelsResults.200m[[best.model.200m]], TestData.200m.N.tetricus.Abundance)
...
ggcorr(TrainingData.250m.N.tetricus.Abundance[, 2:length(TrainingData.250m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.250m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.250m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.250m.N.tetricus.Abundance$sqrt.rugosity_mean_250_clip_01=sqrt(TrainingData.250m.N.tetricus.Abundance$rugosity_mean_250_clip_01)
...
for(i in seq(COMB.250m)){
  ...
  for(j in seq(ncol(tmp.250m))){
    k.250m <- k.250m + 1
    COMB2.250m[[k.250m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.250m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.250m.N.tetricus.Abundance$Predicted.Species.Richness.250m <- predict.gam(ModelsResults.250m[[best.model.250m]], TestData.250m.N.tetricus.Abundance)
...
ggcorr(TrainingData.300m.N.tetricus.Abundance[, 2:length(TrainingData.300m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.300m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.300m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.300m.N.tetricus.Abundance$sqrt.rugosity_mean_300_clip_01=sqrt(TrainingData.300m.N.tetricus.Abundance$rugosity_mean_300_clip_01)
...
for(i in seq(COMB.300m)){
  ...
  for(j in seq(ncol(tmp.300m))){
    k.300m <- k.300m + 1
    COMB2.300m[[k.300m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.300m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.300m.N.tetricus.Abundance$Predicted.Species.Richness.300m <- predict.gam(ModelsResults.300m[[best.model.300m]], TestData.300m.N.tetricus.Abundance)
...
ggcorr(TrainingData.400m.N.tetricus.Abundance[, 2:length(TrainingData.400m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.400m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.400m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.400m.N.tetricus.Abundance$sqrt.rugosity_mean_400_clip_01=sqrt(TrainingData.400m.N.tetricus.Abundance$rugosity_mean_400_clip_01)
...
for(i in seq(COMB.400m)){
  ...
  for(j in seq(ncol(tmp.400m))){
    k.400m <- k.400m + 1
    COMB2.400m[[k.400m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.400m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.400m.N.tetricus.Abundance$Predicted.Species.Richness.400m <- predict.gam(ModelsResults.400m[[best.model.400m]], TestData.400m.N.tetricus.Abundance)
...
ggcorr(TrainingData.500m.N.tetricus.Abundance[, 2:length(TrainingData.500m.N.tetricus.Abundance)], geom = "blank", label = TRUE, hjust = 0.8, label_size = 2, size = 3) +
  geom_point(size = 7, aes(color = coefficient > 0, alpha = abs(coefficient) > 0.5)) +
  scale_alpha_manual(values = c("TRUE" = 0.25, "FALSE" = 0)) +
  guides(color = FALSE, alpha = FALSE)
...
pairs(TrainingData.500m.N.tetricus.Abundance)

#Check Response Variable

plot(TrainingData.500m.N.tetricus.Abundance$N.tetricus.Abundance)


### Transformations
# Example: TrainingData.500m.N.tetricus.Abundance$sqrt.rugosity_mean_500_clip_01=sqrt(TrainingData.500m.N.tetricus.Abundance$rugosity_mean_500_clip_01)
...
for(i in seq(COMB.500m)){
  ...
  for(j in seq(ncol(tmp.500m))){
    k.500m <- k.500m + 1
    COMB2.500m[[k.500m]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.500m[,j], collapse=" + ")))
  }
}
...
# Predict for test data
TestData.500m.N.tetricus.Abundance$Predicted.Species.Richness.500m <- predict.gam(ModelsResults.500m[[best.model.500m]], TestData.500m.N.tetricus.Abundance)
...
BestModelSelection$Pred.Obs.Correlation <- c(with(TestData.5m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.5m, use = "complete.obs")),
                                             with(TestData.10m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.10m, use = "complete.obs")),
                                             with(TestData.25m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.25m, use = "complete.obs")),
                                             with(TestData.50m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.50m, use = "complete.obs")),
                                             with(TestData.75m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.75m, use = "complete.obs")),
                                             with(TestData.100m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.100m, use = "complete.obs")),
                                             with(TestData.150m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.150m, use = "complete.obs")),
                                             with(TestData.200m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.200m, use = "complete.obs")),
                                             with(TestData.250m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.250m, use = "complete.obs")),
                                             with(TestData.300m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.300m, use = "complete.obs")),
                                             with(TestData.400m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.400m, use = "complete.obs")),
                                             with(TestData.500m.N.tetricus.Abundance, cor(N.tetricus.Abundance, Predicted.Species.Richness.500m, use = "complete.obs"))
)
...
write.table(BestModelSelection, file = "01_BestModelSelection_N.tetricus.Abundance.txt" , sep = "\t", row.names = FALSE)
...
for(i in seq(COMB.VI)){
  ...
  for(j in seq(ncol(tmp.VI))){
    k.VI <- k.VI + 1
    COMB2.VI[[k.VI]] <- formula(paste("N.tetricus.Abundance", "~", paste(tmp.VI[,j], collapse=" + ")))
  }
}
...
output.VI$Subset <- "N.tetricus.Abundance"

VariableImportance <- output.VI %>%
  dplyr::select("BestModel.Variables", "Subset", "VariableImportance")

write.table(VariableImportance, file = "01_VariableImportance_N.tetricus.Abundance.txt" , sep = "\t", row.names = FALSE)
...
# Make GAM Plots
pdf(file = "N.tetricus.Abundance_Best_Plots.pdf")
plot.gam(BestModel)
dev.off()
...
N.tetricus.Abundance_AICc_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AICc, group=1)) +
  geom_line()+
  geom_point()+
...
N.tetricus.Abundance_AICc_01
ggsave("AICc_N.tetricus.Abundance_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


N.tetricus.Abundance_Weight_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$weight, group=1)) +
  geom_line()+
  geom_point()+
...
N.tetricus.Abundance_Weight_01
ggsave("Weight_N.tetricus.Abundance_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


N.tetricus.Abundance_Pred.Obs.Correlation_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Pred.Obs.Correlation, group=1)) +
  geom_line()+
  geom_point()+
...
N.tetricus.Abundance_Pred.Obs.Correlation_01
ggsave("Pred.Obs.Correlation_N.tetricus.Abundance_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


N.tetricus.Abundance_logLik_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$logLik, group=1)) +
  geom_line()+
  geom_point()+
...
N.tetricus.Abundance_logLik_01
ggsave("logLik_N.tetricus.Abundance_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)
