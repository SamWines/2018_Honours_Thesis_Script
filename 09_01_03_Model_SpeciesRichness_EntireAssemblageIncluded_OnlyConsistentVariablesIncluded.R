...
# This script is for modelling species richness of the entire assemblage
...
TestData.5m.SpeciesRichness$Predicted.Species.Richness.5m <- as.numeric(predict.gam(Cons_5m_SpRichness_ENTIRE, TestData.5m.SpeciesRichness))
...
# Predict for test data
TestData.10m.SpeciesRichness$Predicted.Species.Richness.10m <- as.numeric(predict.gam(Cons_10m_SpRichness_ENTIRE, TestData.10m.SpeciesRichness))
...
# Predict for test data
TestData.25m.SpeciesRichness$Predicted.Species.Richness.25m <- as.numeric(predict.gam(Cons_25m_SpRichness_ENTIRE, TestData.25m.SpeciesRichness))
...
# Predict for test data
TestData.50m.SpeciesRichness$Predicted.Species.Richness.50m <- as.numeric(predict.gam(Cons_50m_SpRichness_ENTIRE, TestData.50m.SpeciesRichness))
...
# Predict for test data
TestData.75m.SpeciesRichness$Predicted.Species.Richness.75m <- as.numeric(predict.gam(Cons_75m_SpRichness_ENTIRE, TestData.75m.SpeciesRichness))
...
# Predict for test data
TestData.100m.SpeciesRichness$Predicted.Species.Richness.100m <- as.numeric(predict.gam(Cons_100m_SpRichness_ENTIRE, TestData.100m.SpeciesRichness))
...
# Predict for test data
TestData.150m.SpeciesRichness$Predicted.Species.Richness.150m <- as.numeric(predict.gam(Cons_150m_SpRichness_ENTIRE, TestData.150m.SpeciesRichness))
...
# Predict for test data
TestData.200m.SpeciesRichness$Predicted.Species.Richness.200m <- as.numeric(predict.gam(Cons_200m_SpRichness_ENTIRE, TestData.200m.SpeciesRichness))
...
# Predict for test data
TestData.250m.SpeciesRichness$Predicted.Species.Richness.250m <- as.numeric(predict.gam(Cons_250m_SpRichness_ENTIRE, TestData.250m.SpeciesRichness))
...
# Predict for test data
TestData.300m.SpeciesRichness$Predicted.Species.Richness.300m <- as.numeric(predict.gam(Cons_300m_SpRichness_ENTIRE, TestData.300m.SpeciesRichness))
...
# Predict for test data
TestData.400m.SpeciesRichness$Predicted.Species.Richness.400m <- as.numeric(predict.gam(Cons_400m_SpRichness_ENTIRE, TestData.400m.SpeciesRichness))
...
# Predict for test data
TestData.500m.SpeciesRichness$Predicted.Species.Richness.500m <- as.numeric(predict.gam(Cons_500m_SpRichness_ENTIRE, TestData.500m.SpeciesRichness))
