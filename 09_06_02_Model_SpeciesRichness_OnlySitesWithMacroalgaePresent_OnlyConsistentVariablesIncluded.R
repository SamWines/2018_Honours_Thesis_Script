...
# This script is for modelling species richness of the sites with macroalgae present
...
# Import Files
Import.5m.Site.Summaries <- read.table("01_5m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.10m.Site.Summaries <- read.table("01_10m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.25m.Site.Summaries <- read.table("01_25m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.50m.Site.Summaries <- read.table("01_50m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.75m.Site.Summaries <- read.table("01_75m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.100m.Site.Summaries <- read.table("01_100m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.150m.Site.Summaries <- read.table("01_150m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.200m.Site.Summaries <- read.table("01_200m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.250m.Site.Summaries <- read.table("01_250m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.300m.Site.Summaries <- read.table("01_300m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.400m.Site.Summaries <- read.table("01_400m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
Import.500m.Site.Summaries <- read.table("01_500m_SiteSummariesMACROALGAE.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE) 
...
TrainingData.5m.SpeciesRichness$Year <- factor(TrainingData.5m.SpeciesRichness$Year)
TrainingData.5m.SpeciesRichness$Status <- factor(TrainingData.5m.SpeciesRichness$Status)
TestData.5m.SpeciesRichness$Year <- factor(TestData.5m.SpeciesRichness$Year)
TestData.5m.SpeciesRichness$Status <- factor(TestData.5m.SpeciesRichness$Status)
...
Cons_5m_SpRichness_MACROALGAE <- gam(Formula.5m, data = data.5m)

# Predict for test data
TestData.5m.SpeciesRichness$Predicted.Species.Richness.5m <- as.numeric(predict.gam(Cons_5m_SpRichness_MACROALGAE, TestData.5m.SpeciesRichness))
...
TrainingData.10m.SpeciesRichness$Year <- factor(TrainingData.10m.SpeciesRichness$Year)
TrainingData.10m.SpeciesRichness$Status <- factor(TrainingData.10m.SpeciesRichness$Status)
TestData.10m.SpeciesRichness$Year <- factor(TestData.10m.SpeciesRichness$Year)
TestData.10m.SpeciesRichness$Status <- factor(TestData.10m.SpeciesRichness$Status)
...
Cons_10m_SpRichness_MACROALGAE <- gam(Formula.10m, data = data.10m)

# Predict for test data
TestData.10m.SpeciesRichness$Predicted.Species.Richness.10m <- as.numeric(predict.gam(Cons_10m_SpRichness_MACROALGAE, TestData.10m.SpeciesRichness))
...
TrainingData.25m.SpeciesRichness$Year <- factor(TrainingData.25m.SpeciesRichness$Year)
TrainingData.25m.SpeciesRichness$Status <- factor(TrainingData.25m.SpeciesRichness$Status)
TestData.25m.SpeciesRichness$Year <- factor(TestData.25m.SpeciesRichness$Year)
TestData.25m.SpeciesRichness$Status <- factor(TestData.25m.SpeciesRichness$Status)
...
Cons_25m_SpRichness_MACROALGAE <- gam(Formula.25m, data = data.25m)

# Predict for test data
TestData.25m.SpeciesRichness$Predicted.Species.Richness.25m <- as.numeric(predict.gam(Cons_25m_SpRichness_MACROALGAE, TestData.25m.SpeciesRichness))
...
TrainingData.50m.SpeciesRichness$Year <- factor(TrainingData.50m.SpeciesRichness$Year)
TrainingData.50m.SpeciesRichness$Status <- factor(TrainingData.50m.SpeciesRichness$Status)
TestData.50m.SpeciesRichness$Year <- factor(TestData.50m.SpeciesRichness$Year)
TestData.50m.SpeciesRichness$Status <- factor(TestData.50m.SpeciesRichness$Status)
...
Cons_50m_SpRichness_MACROALGAE <- gam(Formula.50m, data = data.50m)

# Predict for test data
TestData.50m.SpeciesRichness$Predicted.Species.Richness.50m <- as.numeric(predict.gam(Cons_50m_SpRichness_MACROALGAE, TestData.50m.SpeciesRichness))
...
TrainingData.75m.SpeciesRichness$Year <- factor(TrainingData.75m.SpeciesRichness$Year)
TrainingData.75m.SpeciesRichness$Status <- factor(TrainingData.75m.SpeciesRichness$Status)
TestData.75m.SpeciesRichness$Year <- factor(TestData.75m.SpeciesRichness$Year)
TestData.75m.SpeciesRichness$Status <- factor(TestData.75m.SpeciesRichness$Status)
...
Cons_75m_SpRichness_MACROALGAE <- gam(Formula.75m, data = data.75m)

# Predict for test data
TestData.75m.SpeciesRichness$Predicted.Species.Richness.75m <- as.numeric(predict.gam(Cons_75m_SpRichness_MACROALGAE, TestData.75m.SpeciesRichness))
...
TrainingData.100m.SpeciesRichness$Year <- factor(TrainingData.100m.SpeciesRichness$Year)
TrainingData.100m.SpeciesRichness$Status <- factor(TrainingData.100m.SpeciesRichness$Status)
TestData.100m.SpeciesRichness$Year <- factor(TestData.100m.SpeciesRichness$Year)
TestData.100m.SpeciesRichness$Status <- factor(TestData.100m.SpeciesRichness$Status)
...
Cons_100m_SpRichness_MACROALGAE <- gam(Formula.100m, data = data.100m)

# Predict for test data
TestData.100m.SpeciesRichness$Predicted.Species.Richness.100m <- as.numeric(predict.gam(Cons_100m_SpRichness_MACROALGAE, TestData.100m.SpeciesRichness))
...
TrainingData.150m.SpeciesRichness$Year <- factor(TrainingData.150m.SpeciesRichness$Year)
TrainingData.150m.SpeciesRichness$Status <- factor(TrainingData.150m.SpeciesRichness$Status)
TestData.150m.SpeciesRichness$Year <- factor(TestData.150m.SpeciesRichness$Year)
TestData.150m.SpeciesRichness$Status <- factor(TestData.150m.SpeciesRichness$Status)
...
Cons_150m_SpRichness_MACROALGAE <- gam(Formula.150m, data = data.150m)

# Predict for test data
TestData.150m.SpeciesRichness$Predicted.Species.Richness.150m <- as.numeric(predict.gam(Cons_150m_SpRichness_MACROALGAE, TestData.150m.SpeciesRichness))
...
TrainingData.200m.SpeciesRichness$Year <- factor(TrainingData.200m.SpeciesRichness$Year)
TrainingData.200m.SpeciesRichness$Status <- factor(TrainingData.200m.SpeciesRichness$Status)
TestData.200m.SpeciesRichness$Year <- factor(TestData.200m.SpeciesRichness$Year)
TestData.200m.SpeciesRichness$Status <- factor(TestData.200m.SpeciesRichness$Status)
...
Cons_200m_SpRichness_MACROALGAE <- gam(Formula.200m, data = data.200m)

# Predict for test data
TestData.200m.SpeciesRichness$Predicted.Species.Richness.200m <- as.numeric(predict.gam(Cons_200m_SpRichness_MACROALGAE, TestData.200m.SpeciesRichness))
...
TrainingData.250m.SpeciesRichness$Year <- factor(TrainingData.250m.SpeciesRichness$Year)
TrainingData.250m.SpeciesRichness$Status <- factor(TrainingData.250m.SpeciesRichness$Status)
TestData.250m.SpeciesRichness$Year <- factor(TestData.250m.SpeciesRichness$Year)
TestData.250m.SpeciesRichness$Status <- factor(TestData.250m.SpeciesRichness$Status)
...
Cons_250m_SpRichness_MACROALGAE <- gam(Formula.250m, data = data.250m)

# Predict for test data
TestData.250m.SpeciesRichness$Predicted.Species.Richness.250m <- as.numeric(predict.gam(Cons_250m_SpRichness_MACROALGAE, TestData.250m.SpeciesRichness))
...
TrainingData.300m.SpeciesRichness$Year <- factor(TrainingData.300m.SpeciesRichness$Year)
TrainingData.300m.SpeciesRichness$Status <- factor(TrainingData.300m.SpeciesRichness$Status)
TestData.300m.SpeciesRichness$Year <- factor(TestData.300m.SpeciesRichness$Year)
TestData.300m.SpeciesRichness$Status <- factor(TestData.300m.SpeciesRichness$Status)
...
Cons_300m_SpRichness_MACROALGAE <- gam(Formula.300m, data = data.300m)

# Predict for test data
TestData.300m.SpeciesRichness$Predicted.Species.Richness.300m <- as.numeric(predict.gam(Cons_300m_SpRichness_MACROALGAE, TestData.300m.SpeciesRichness))
...
TrainingData.400m.SpeciesRichness$Year <- factor(TrainingData.400m.SpeciesRichness$Year)
TrainingData.400m.SpeciesRichness$Status <- factor(TrainingData.400m.SpeciesRichness$Status)
TestData.400m.SpeciesRichness$Year <- factor(TestData.400m.SpeciesRichness$Year)
TestData.400m.SpeciesRichness$Status <- factor(TestData.400m.SpeciesRichness$Status)
...
Cons_400m_SpRichness_MACROALGAE <- gam(Formula.400m, data = data.400m)

# Predict for test data
TestData.400m.SpeciesRichness$Predicted.Species.Richness.400m <- as.numeric(predict.gam(Cons_400m_SpRichness_MACROALGAE, TestData.400m.SpeciesRichness))
...
TrainingData.500m.SpeciesRichness$Year <- factor(TrainingData.500m.SpeciesRichness$Year)
TrainingData.500m.SpeciesRichness$Status <- factor(TrainingData.500m.SpeciesRichness$Status)
TestData.500m.SpeciesRichness$Year <- factor(TestData.500m.SpeciesRichness$Year)
TestData.500m.SpeciesRichness$Status <- factor(TestData.500m.SpeciesRichness$Status)
...
Cons_500m_SpRichness_MACROALGAE <- gam(Formula.500m, data = data.500m)

# Predict for test data
TestData.500m.SpeciesRichness$Predicted.Species.Richness.500m <- as.numeric(predict.gam(Cons_500m_SpRichness_MACROALGAE, TestData.500m.SpeciesRichness))
...
best.model.selection.5m$Formula <- as.character(c(Cons_5m_SpRichness_MACROALGAE$formula))
best.model.selection.10m$Formula <- as.character(c(Cons_10m_SpRichness_MACROALGAE$formula))
best.model.selection.25m$Formula <- as.character(c(Cons_25m_SpRichness_MACROALGAE$formula))
best.model.selection.50m$Formula <- as.character(c(Cons_50m_SpRichness_MACROALGAE$formula))
best.model.selection.75m$Formula <- as.character(c(Cons_75m_SpRichness_MACROALGAE$formula))
best.model.selection.100m$Formula <- as.character(c(Cons_100m_SpRichness_MACROALGAE$formula))
best.model.selection.150m$Formula <- as.character(c(Cons_150m_SpRichness_MACROALGAE$formula))
best.model.selection.200m$Formula <- as.character(c(Cons_200m_SpRichness_MACROALGAE$formula))
best.model.selection.250m$Formula <- as.character(c(Cons_250m_SpRichness_MACROALGAE$formula))
best.model.selection.300m$Formula <- as.character(c(Cons_300m_SpRichness_MACROALGAE$formula))
best.model.selection.400m$Formula <- as.character(c(Cons_400m_SpRichness_MACROALGAE$formula))
best.model.selection.500m$Formula <- as.character(c(Cons_500m_SpRichness_MACROALGAE$formula))

best.model.selection.5m$AIC.mgcv <- as.character(c(Cons_5m_SpRichness_MACROALGAE$aic))
best.model.selection.10m$AIC.mgcv <- as.character(c(Cons_10m_SpRichness_MACROALGAE$aic))
best.model.selection.25m$AIC.mgcv <- as.character(c(Cons_25m_SpRichness_MACROALGAE$aic))
best.model.selection.50m$AIC.mgcv <- as.character(c(Cons_50m_SpRichness_MACROALGAE$aic))
best.model.selection.75m$AIC.mgcv <- as.character(c(Cons_75m_SpRichness_MACROALGAE$aic))
best.model.selection.100m$AIC.mgcv <- as.character(c(Cons_100m_SpRichness_MACROALGAE$aic))
best.model.selection.150m$AIC.mgcv <- as.character(c(Cons_150m_SpRichness_MACROALGAE$aic))
best.model.selection.200m$AIC.mgcv <- as.character(c(Cons_200m_SpRichness_MACROALGAE$aic))
best.model.selection.250m$AIC.mgcv <- as.character(c(Cons_250m_SpRichness_MACROALGAE$aic))
best.model.selection.300m$AIC.mgcv <- as.character(c(Cons_300m_SpRichness_MACROALGAE$aic))
best.model.selection.400m$AIC.mgcv <- as.character(c(Cons_400m_SpRichness_MACROALGAE$aic))
best.model.selection.500m$AIC.mgcv <- as.character(c(Cons_500m_SpRichness_MACROALGAE$aic))

best.model.selection.5m$Deviance.Explained <- as.numeric(((Cons_5m_SpRichness_MACROALGAE$null.deviance - Cons_5m_SpRichness_MACROALGAE$deviance)/Cons_5m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.10m$Deviance.Explained <- as.numeric(((Cons_10m_SpRichness_MACROALGAE$null.deviance - Cons_10m_SpRichness_MACROALGAE$deviance)/Cons_10m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.25m$Deviance.Explained <- as.numeric(((Cons_25m_SpRichness_MACROALGAE$null.deviance - Cons_25m_SpRichness_MACROALGAE$deviance)/Cons_25m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.50m$Deviance.Explained <- as.numeric(((Cons_50m_SpRichness_MACROALGAE$null.deviance - Cons_50m_SpRichness_MACROALGAE$deviance)/Cons_50m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.75m$Deviance.Explained <- as.numeric(((Cons_75m_SpRichness_MACROALGAE$null.deviance - Cons_75m_SpRichness_MACROALGAE$deviance)/Cons_75m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.100m$Deviance.Explained <- as.numeric(((Cons_100m_SpRichness_MACROALGAE$null.deviance - Cons_100m_SpRichness_MACROALGAE$deviance)/Cons_100m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.150m$Deviance.Explained <- as.numeric(((Cons_150m_SpRichness_MACROALGAE$null.deviance - Cons_150m_SpRichness_MACROALGAE$deviance)/Cons_150m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.200m$Deviance.Explained <- as.numeric(((Cons_200m_SpRichness_MACROALGAE$null.deviance - Cons_200m_SpRichness_MACROALGAE$deviance)/Cons_200m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.250m$Deviance.Explained <- as.numeric(((Cons_250m_SpRichness_MACROALGAE$null.deviance - Cons_250m_SpRichness_MACROALGAE$deviance)/Cons_250m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.300m$Deviance.Explained <- as.numeric(((Cons_300m_SpRichness_MACROALGAE$null.deviance - Cons_300m_SpRichness_MACROALGAE$deviance)/Cons_300m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.400m$Deviance.Explained <- as.numeric(((Cons_400m_SpRichness_MACROALGAE$null.deviance - Cons_400m_SpRichness_MACROALGAE$deviance)/Cons_400m_SpRichness_MACROALGAE$null.deviance)*100)
best.model.selection.500m$Deviance.Explained <- as.numeric(((Cons_500m_SpRichness_MACROALGAE$null.deviance - Cons_500m_SpRichness_MACROALGAE$deviance)/Cons_500m_SpRichness_MACROALGAE$null.deviance)*100)
...
SpeciesRichness_AIC.mgcv_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$AIC.mgcv, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness_AIC.mgcv_01
ggsave("AICmgcv_SpeciesRichness_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)


SpeciesRichness_DevExplained_01 <- ggplot(data=BestModelSelection, aes(x=BestModelSelection$Scale, y=BestModelSelection$Deviance.Explained, group=1)) +
  geom_line()+
  geom_point()+
...
SpeciesRichness_DevExplained_01
ggsave("DevExplained_SpeciesRichness_01.png", plot = last_plot(), device = "png",
       scale = 1, dpi = 300, limitsize = TRUE)
